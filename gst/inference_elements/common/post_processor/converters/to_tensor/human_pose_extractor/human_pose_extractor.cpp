...
HumanPoseExtractor::HumanPoseExtractor(size_t keypoints_number, ResizeDeviceType maps_resize_device_type)
    : keypoints_number(keypoints_number), min_joints_number(2), stride(8), mean_pixel(cv::Vec3f::all(128)),
      min_peaks_distance(1.0f), mid_points_score_threshold(0.03f), found_mid_points_ratio_threshold(0.7f),
      min_subset_score(0.05f), upsample_ratio(4), maps_resize_device_type(maps_resize_device_type) {
}
